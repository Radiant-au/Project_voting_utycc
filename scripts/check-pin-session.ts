...
const voter = createVoterSession('00000000-0000-0000-0000-000000000001', 100);
...
assert.match(voteRoute, /signedVoterSession\(\)/);
assert.match(voteRoute, /input_voting_session_id/);
assert.match(voteRoute, /idempotency-key/);
