...
export const projects: Project[] = [
  ...
  ['p4','04','Air We Share','Mapping invisible air currents through the school day.','A network of handmade paper pinwheels and open-source monitors reveals how air moves from classroom to classroom. The project pairs rigorous observation with a very human question: who gets the freshest air?','Advanced Material Engineering','North Wing Lab','1535378917042-10a22c3a2f9c','Air quality','Open data'],
  ['p5','05','Second Skin','A collection of garments grown from food waste.','We experimented with bacterial cellulose made from fruit scraps, developing translucent sheets that can be stitched, dyed and composted at the end of their life.','Precision Engineering','Mend / Make','1529139574466-a303027c1d8b','Bio-materials','Circular design'],
  ['p6','06','Small Acts, Big Map','A neighbourhood map built from everyday acts of care.','Every mark on this hand-drawn map represents a small act of care: a repaired bike, a shared meal, a borrowed book. It asks us to notice the infrastructure of kindness around us.','Information Science and Technology','The Listening Post','1529156069898-49953e39b3ac','Field notes','Participatory map'],
  ...
  ['p9','09','The Quiet Machine','A kinetic sculpture that responds to the sounds of a room.','When the room is loud, the machine folds in on itself. When it is quiet, it unfolds slowly. Our sculpture turns collective attention into a visible, shared choreography.','Advanced Material Engineering','Soft Mechanisms','1531058020387-3be344556be6','Kinetic sculpture','Sound reactive'],
  ['p10','10','Pocket Pollinators','A pocket-sized habitat kit for balconies and window ledges.','A kit of seed cards, nesting tubes and illustrated instructions helps people make small habitats wherever they live. We tested the kits with neighbours across three apartment blocks.','Precision Engineering','Wild Window','1497250681960-ef046c4e94d2','Urban ecology','Take-home kit'],
  ['p11','11','Language Weather','A forecast made from the words our school uses every day.','We collected anonymous snippets of school language and visualised their mood over a month. The result is a changing weather map that reflects how a community speaks to itself.','Information Science and Technology','Word Watch','1499750310107-5fef28a66643','Text analysis','Community research'],
