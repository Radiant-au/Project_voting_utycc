...
export function ProjectDetailsPage() {
  ...
  return (
    <main className="utycc-page projects-page">
      ...
      <div className="relative z-[1] mx-auto max-w-5xl px-4 pb-16 sm:px-6">
        ...
        <article className="glass-project-details">
          ...
          <section>
            ...
            <h1>{project.title}</h1>
            <p className="details-team">{project.teamName}</p>
            <p className="details-description">{project.fullDescription}</p>
        ...
        <Modal onClose={() => !submitting && setModal(false)}>
          ...
          <div className="mt-4 rounded-xl bg-secondary p-4 text-sm">
            <div className="flex justify-between">
              ...
              <strong>{categoryLabels[session.category]} Voter</strong>
            </div>
            <div className="mt-2 flex justify-between">
              <span className="text-muted-foreground">Contribution</span>
              <strong>{pointValues[session.category]} weighted points</strong>
            </div>
          </div>
